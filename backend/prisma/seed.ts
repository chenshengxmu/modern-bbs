...
async function main() {
  ...
  await prisma.post.create({
    data: {
      title: 'Why Prisma + SQLite is great for local dev',
      content: 'Prisma provides great type safety and SQLite makes it incredibly easy to share the development environment without complex database setups.',
      authorId: admin.id,
      boardId: tech.id,
      viewCount: 89,
      likeCount: 12,
